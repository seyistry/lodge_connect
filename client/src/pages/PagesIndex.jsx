        ...
        <div className="flex justify-center ">
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex mt-2  gap-2">
              <input
                className="border py-2 px-1 border-gray-400  w-full flex-2 rounded-2xl"
                type="text"
                placeholder="Add using addistonal link"
              />
              <button className="flex-1 bg-gray-100 px-3 rounded-md">
                Add&nbsp;Pictures
              </button>
            </div>
            {/* Upload button */}
            ...
            />
            <div className="flex justify-center ">
              <button className="border mt-2 px-6 py-2  bg-red-200 text-white rounded-2xl">
                Upload{' '}
              </button>
            </div>
          </form>
